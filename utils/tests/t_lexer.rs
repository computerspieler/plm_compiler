...
const KEYWORDS: [&'static str; 0] = [];

#[test]
fn test_initialisation() {
	let mut lexer = Lexer::from_string("".to_string(), &KEYWORDS);
...
fn test_special_token17() {
	let mut lexer = Lexer::from_string("\r".to_string(), &KEYWORDS);
	assert_token!(lexer, None)
}
...
fn test_invalid_number0() {
	let mut lexer = Lexer::from_string("01l,Y".to_string(), &KEYWORDS);
	assert_token!(lexer, None)
}

#[test]
fn test_invalid_number1() {
	let mut lexer = Lexer::from_string("36:$".to_string(), &KEYWORDS);
...
fn test_invalid_number2() {
	let mut lexer = Lexer::from_string("83ew".to_string(), &KEYWORDS);
	assert_token!(lexer, None)
}

#[test]
fn test_invalid_number3() {
	let mut lexer = Lexer::from_string("30nKn".to_string(), &KEYWORDS);
	assert_token!(lexer, None)
}

#[test]
fn test_invalid_number4() {
	let mut lexer = Lexer::from_string("38lW".to_string(), &KEYWORDS);
	assert_token!(lexer, None)
}

#[test]
fn test_invalid_number5() {
	let mut lexer = Lexer::from_string("66PID".to_string(), &KEYWORDS);
	assert_token!(lexer, None)
}

#[test]
fn test_invalid_number6() {
	let mut lexer = Lexer::from_string("33wQ".to_string(), &KEYWORDS);
	assert_token!(lexer, None)
}

#[test]
fn test_invalid_number7() {
	let mut lexer = Lexer::from_string("91IC".to_string(), &KEYWORDS);
	assert_token!(lexer, None)
}

#[test]
fn test_invalid_number8() {
	let mut lexer = Lexer::from_string("23/".to_string(), &KEYWORDS);
...
fn test_invalid_number9() {
	let mut lexer = Lexer::from_string("07Xv".to_string(), &KEYWORDS);
	assert_token!(lexer, None)
}

#[test]
fn test_valid_number0() {
	let mut lexer = Lexer::from_string("354356D".to_string(), &KEYWORDS);
...
fn test_valid_number1() {
	let mut lexer = Lexer::from_string("10111110100011010B".to_string(), &KEYWORDS);
...
fn test_valid_number2() {
	let mut lexer = Lexer::from_string("    202117d".to_string(), &KEYWORDS);
...
fn test_valid_number3() {
	let mut lexer = Lexer::from_string("1124013o    ".to_string(), &KEYWORDS);
...
fn test_valid_number4() {
	let mut lexer = Lexer::from_string("111000011111110011b".to_string(), &KEYWORDS);
...
fn test_valid_number5() {
	let mut lexer = Lexer::from_string("688978D".to_string(), &KEYWORDS);
...
fn test_valid_number6() {
	let mut lexer = Lexer::from_string("0ca7f8h".to_string(), &KEYWORDS);
...
fn test_valid_number7() {
	let mut lexer = Lexer::from_string("11101110110101000000b".to_string(), &KEYWORDS);
...
fn test_valid_number8() {
	let mut lexer = Lexer::from_string("2001241q".to_string(), &KEYWORDS);
...
fn test_valid_number9() {
	let mut lexer = Lexer::from_string("1375475Q".to_string(), &KEYWORDS);
...
fn test_valid_identifier0() {
	let mut lexer = Lexer::from_string("a$".to_string(), &KEYWORDS);
...
fn test_valid_identifier1() {
	let mut lexer = Lexer::from_string("plv$kU0Yn0tuTQC3pXNNv$Jnbdb".to_string(), &KEYWORDS);
...
fn test_valid_identifier2() {
	let mut lexer = Lexer::from_string("AtP4I1Hi1RgLRcVLgBzXELk8PJwHecc1wzFnt$h11MyvHmBr6s5xOQNOdaY5I0PJQ8ScqT172dCnMqq8BcCYIIfoJRB39K1Lgy7jic2sX    ".to_string(), &KEYWORDS);
...
fn test_valid_identifier3() {
	let mut lexer = Lexer::from_string("    LDBWARGp4MiulqWezW2dyVrtmJHzVdKulx".to_string(), &KEYWORDS);
...
fn test_valid_identifier4() {
	let mut lexer = Lexer::from_string("jYw8qjy78dfIr725oWgd1JWY9S2ptAE680yT5oIh8svx8GmOpoAJyIrEzFPUihzX6OYToZ7Wvd8UJv3rEP5mtd692Qs7dJQIE".to_string(), &KEYWORDS);
...
fn test_valid_identifier5() {
	let mut lexer = Lexer::from_string("IwKgr$aTN6zMSei3WaNHA16ys2wnLELl7QP8T5FNtWM4QxUj6lvwfUEcl0gf$TXHiDXOxC3xlrwFaw4FgU1ue3j3QbTjeBkSX".to_string(), &KEYWORDS);
...
fn test_valid_identifier6() {
	let mut lexer = Lexer::from_string("RuNqbaO".to_string(), &KEYWORDS);
...
fn test_valid_identifier7() {
	let mut lexer =
		Lexer::from_string("tWFBPR8v1hFploLU6z8OvZIXUVfDhh$yYSGUl4alsjMkoEsJS".to_string(), &KEYWORDS);
...
fn test_valid_identifier8() {
	let mut lexer = Lexer::from_string("    Edn1pijs9gOd1sk6GhUUn5rYaWag2PZdlXHG93gqf2Dy2DfuD8C4aYXGcE0PenvGBxKX9NlRZL7gzXSDl1Vp1w1asFddTh4E3gwTF5JebMX2nZ8kVBUQf9g".to_string(), &KEYWORDS);
...
fn test_valid_identifier9() {
	let mut lexer =
		Lexer::from_string("siS8dbRgE$yi0P47zkW02GyYVbJ5$881ahHBonqwNlD$mMrr5".to_string(), &KEYWORDS);
...
fn test_valid_identifier10() {
	let mut lexer = Lexer::from_string("eynneH28hTeJnN6fNeKeollFwnWFhciNgtMrWY2vTcLjYOi13TdpjNMaA2kWX75Ak7giAIWT2Ayd40QZcFBylTjdnYpNZJRpkUJ$d".to_string(), &KEYWORDS);
...
fn test_valid_identifier11() {
	let mut lexer =
		Lexer::from_string("L5cHqWpT3e31pLqeNdCns1J0DORsJsXQoznV13qyj1hRdW".to_string(), &KEYWORDS);
...
fn test_valid_identifier12() {
	let mut lexer = Lexer::from_string("TKcgWxKQ4kNamFo$DCy1AY1OdH5ysTYk4VQVNpL44Yi86J6KIXbyBAmoMsp9TbQBk8JvunOD3KxTD5EOgiqjx9pcj1BQjapjHhC0".to_string(), &KEYWORDS);
...
fn test_valid_identifier13() {
	let mut lexer = Lexer::from_string("Rr5xJO9sE5EaSWDufQYO4M8FIZlNvohah93AwR6qDrvA$rnsMgjuHpq0tJjV74mkxvhFKi23i8Bnqx1UYYRVtPqAcAautl46qHSgvabhVonmj3qK".to_string(), &KEYWORDS);
...
fn test_valid_identifier14() {
	let mut lexer =
		Lexer::from_string("Txg9Vw1WsW$fa6G2hbQTvA1ljJXB5SgKqSotoO$khMfm2Ig9".to_string(), &KEYWORDS);
...
fn test_valid_identifier15() {
	let mut lexer = Lexer::from_string("q2Hfyt6qgxo$E8xnrzEHsN7QPRSpSmX4wG5fhVFEt0JARon01hRvr11BEXCqlTT2bNL1oK0ME$cARZXXqH1koCkEUVG3wX".to_string(), &KEYWORDS);
...
fn test_valid_identifier16() {
	let mut lexer = Lexer::from_string("f5qFXeiaIpgLQg7KSCwqyQH".to_string(), &KEYWORDS);
...
fn test_valid_identifier17() {
	let mut lexer =
		Lexer::from_string("gFpW$3BGnzTip9s6ymQMr5LK6R2jCvtcZnKTDgOSpP9Zov".to_string(), &KEYWORDS);
...
fn test_valid_identifier18() {
	let mut lexer = Lexer::from_string("tfpsgnEoBS5Y4e4laItjRrsgzxaeSE".to_string(), &KEYWORDS);
...
fn test_valid_identifier20() {
	let mut lexer = Lexer::from_string("AMU8uRiD0iAEzXOvPnRq6aScCq2YljjUa3oRT6zodOpCL28Xeh67SZoCPbzGr7f0tbtVBMgXdMowR9XCPBoIxtpfnOe6xZAsRfW2563tmMaDbyam".to_string(), &KEYWORDS);
...
fn test_valid_identifier21() {
	let mut lexer = Lexer::from_string("COCHh8lmFdY$QZqCGO$gI17fPyzhEhPDmZTNmepp7ID9".to_string(), &KEYWORDS);
...
fn test_valid_identifier22() {
	let mut lexer = Lexer::from_string("XW4uNpfmMXQkRfuybTM0n5f9xksUIKrzehA2xyRx8QMPapjCPfPg47fJWAZzVbN0jdiEIHrOL4kUdXKzClgxusjX4ib5ZcXWiSKHIgGOzwB0".to_string(), &KEYWORDS);
...
fn test_valid_identifier23() {
	let mut lexer = Lexer::from_string("M0sazyN8RFTZcEnddo4MJ97Y8R3mzDE3RwQLSAn".to_string(), &KEYWORDS);
...
fn test_valid_identifier25() {
	let mut lexer = Lexer::from_string("BdfeOOxm6tneK8FI5CSwwW82iwrC40IieFo4sh4bXy99J2kfijyLNInySfZrRusxCly2555hzQPzX1dWN7jfYbinUMvXWVIPbXJEnLT".to_string(), &KEYWORDS);
...
fn test_valid_identifier26() {
	let mut lexer = Lexer::from_string("QI69sbnBep9VGRF37oTxASCb8HJR8tjB5UG1FujK6wUCeGJKlHAVJOKVXRoXbwr3nYLyiSb44hnxj$CosHQuBSeXNA0SupaiT4".to_string(), &KEYWORDS);
...
fn test_valid_identifier27() {
	let mut lexer = Lexer::from_string("BtV1s3tYxSksZB$t6VAStW1DtRp1APzDg5aggc4IvXYSPNdUKTDzxLb9AlLYxXe2cPTDDjv4Bssomt1ioexmtdf4ORnjq$DkMTT3o".to_string(), &KEYWORDS);
...
fn test_valid_identifier29() {
	let mut lexer = Lexer::from_string("QaQvwAjuo9UKro9QuiGmc1nAItyWOAPwxG5apOynl".to_string(), &KEYWORDS);
...
fn test_valid_identifier30() {
	let mut lexer = Lexer::from_string("lVj6YJDQftggckkBZ1hRyJtgWsZFi$MjWlotBA6oRcHDVftlhcRxu5nRKLKs8zdnQORYyMIQlV2EVKZKbQTLbhugbmjOsiCOzGp$Dy2tym2H0rOx".to_string(), &KEYWORDS);
...
fn test_valid_identifier31() {
	let mut lexer = Lexer::from_string("aL$3skSRj7XMbCN".to_string(), &KEYWORDS);
...
fn test_valid_identifier32() {
	let mut lexer = Lexer::from_string("uRs0WcYGgy0$MEp9uGITbLmJdosX17kZOTO2BbOMS1h8lf$2Rp74zxs$15Xkl91MuXKmydgqZL4YvPkiQ7B5zStXFIMtYOg7R6ejlCmRfVoYpS$gMbqu8zY".to_string(), &KEYWORDS);
...
fn test_valid_identifier34() {
	let mut lexer = Lexer::from_string("IAc5whNqcA4AFjI56zn5QrGBvV668KuuoPDedY1FjAPkTyFH3rS8OLH13PfXBh2L3XEPQYq8WXmFhRRZ47X8WJed4JEPYRFjCzsLotq2$".to_string(), &KEYWORDS);
...
fn test_valid_identifier36() {
	let mut lexer =
		Lexer::from_string("G2$36FHxbQFWYQ4olA92yzYCfx3IRtWEtBMPyEWx3yVA2gIuT".to_string(), &KEYWORDS);
...
fn test_valid_identifier37() {
	let mut lexer = Lexer::from_string("EdMmo8D9pj1jcQ$6EGnZSrzhc7zQM1AjGF47ozU".to_string(), &KEYWORDS);
...
fn test_valid_identifier39() {
	let mut lexer = Lexer::from_string("EK4tweLq20Vglt76tW".to_string(), &KEYWORDS);
...
fn test_valid_identifier40() {
	let mut lexer = Lexer::from_string("plv$kY".to_string(), &KEYWORDS);
...
fn test_valid_macro0() {
	let mut lexer = Lexer::from_string("CR".to_string(), &KEYWORDS);
...
fn test_valid_macro1() {
	let mut lexer = Lexer::from_string("CR LF".to_string(), &KEYWORDS);
	lexer.add_macro("CR".to_string(), Position::zero(), "10".to_string());
...
fn test_valid_macro2() {
	let mut lexer = Lexer::from_string("CRLF".to_string(), &KEYWORDS);
	lexer.add_macro("CR".to_string(), Position::zero(), "10".to_string());
	lexer.add_macro("LF".to_string(), Position::zero(), "14".to_string());
