...
test!(sll__ix_DIS__, [SLL(AddressRegisterWithOffset(IX, DIS))], [0xDD, 0xCB, DIS, 0x36], DIS: i8);
test!(sll__iy__, [SLL(AddressRegister(IY))], [0xFD, 0xCB, 0x00, 0x36]);
test!(sll__iy_DIS__, [SLL(AddressRegisterWithOffset(IY, DIS))], [0xFD, 0xCB, DIS, 0x36], DIS: i8);
...
//test!(ld__ix_DIS__bc_, [LD(AddressRegisterWithOffset(IX, DIS),WordRegister(BC))], [0xDD, 0x71, DIS, 0xDD, 0x70, DIS]),+1
...
//test!(ld__ix_DIS__de_, [LD(AddressRegisterWithOffset(IX, DIS),WordRegister(DE))], [0xDD, 0x73, DIS, 0xDD, 0x72, DIS]),+1
...
//test!(ld__ix_DIS__hl_, [LD(AddressRegisterWithOffset(IX, DIS),WordRegister(HL))], [0xDD, 0x75, DIS, 0xDD, 0x74, DIS]),+1
...
//test!(ld__iy_DIS__bc_, [LD(AddressRegisterWithOffset(IY, DIS),WordRegister(BC))], [0xFD, 0x71, DIS, 0xFD, 0x70, DIS]),+1
...
//test!(ld__iy_DIS__de_, [LD(AddressRegisterWithOffset(IY, DIS),WordRegister(DE))], [0xFD, 0x73, DIS, 0xFD, 0x72, DIS]),+1
...
//test!(ld__iy_DIS__hl_, [LD(AddressRegisterWithOffset(IY, DIS),WordRegister(HL))], [0xFD, 0x75, DIS, 0xFD, 0x74, DIS]),+1
...
//test!(ld_bc__ix_DIS__, [LD(WordRegister(BC),AddressRegisterWithOffset(IX, DIS))], [0xDD, 0x4E, DIS, 0xDD, 0x46, DIS]),+1
//test!(ld_bc__iy_DIS__, [LD(WordRegister(BC),AddressRegisterWithOffset(IY, DIS))], [0xFD, 0x4E, DIS, 0xFD, 0x46, DIS]),+1
...
//test!(ld_de__ix_DIS__, [LD(WordRegister(DE),AddressRegisterWithOffset(IX, DIS))], [0xDD, 0x5E, DIS, 0xDD, 0x56, DIS]),+1
test!(ld_de__iy__, [LD(WordRegister(DE),AddressRegister(IY))], [0xFD, 0x5E, 0x00, 0xFD, 0x56, 0x01]);
//test!(ld_de__iy_DIS__, [LD(WordRegister(DE),AddressRegisterWithOffset(IY, DIS))], [0xFD, 0x5E, DIS, 0xFD, 0x56, DIS]),+1
...
//test!(ld_hl__ix_DIS__, [LD(WordRegister(HL),AddressRegisterWithOffset(IX, DIS))], [0xDD, 0x6E, DIS, 0xDD, 0x66, DIS]),+1
//test!(ld_hl__iy_DIS__, [LD(WordRegister(HL),AddressRegisterWithOffset(IY, DIS))], [0xFD, 0x6E, DIS, 0xFD, 0x66, DIS]),+1
...
test_ub!(ld_ixh_N_, [LD(IXH,Constant(n as i32))], [0xDD, 0x26, n], n: u8);
test_ub!(ld_ixl_N_, [LD(IXL,Constant(n as i32))], [0xDD, 0x2E, n], n: u8);
...
test_ub!(ld_iyh_N_, [LD(IYH,Constant(n as i32))], [0xFD, 0x26, n], n: u8);
test_ub!(ld_iyl_N_, [LD(IYL,Constant(n as i32))], [0xFD, 0x2E, n], n: u8);
